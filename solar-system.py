...
class Planet():
    def __init__(self, radius,speed, color, x_radius, y_radius):
        self.radius = radius
        self.speed = speed
        self.degree = 0
        self.color = color
...
mercury = Planet(4.8,2.35,grey, 90,45)
venus = Planet(9.5,1.8,orange, 140,60)
earth = Planet(10,1.5,mid_blue, 180,80)
mars = Planet(5.3,1.2,red, 230,100)
jupiter = Planet(30,0.65,creamy, 300, 160)
saturn = Planet(24,0.49,dark_orange, 400, 220)
uranus = Planet(18,0.34,light_blue, 500, 290)
neptune = Planet(15.8,0.27,blue, 580, 330)
